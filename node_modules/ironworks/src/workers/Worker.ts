...
class Worker implements IWorker {
    ...
    protected getCommEvent(event: ICommEvent|string, method?: string): ICommEvent {
        var evt: ICommEvent;
        ...
        evt.prefix = _.isUndefined(split[4]) ? this.comm.prefix() : split[4];
        evt.service = _.isUndefined(split[3]) ? this.service.name : split[3];
        evt.method = _.isUndefined(split[2]) ? method : split[2];
        evt.worker = _.isUndefined(split[1]) ? this.me.name : split[1];
