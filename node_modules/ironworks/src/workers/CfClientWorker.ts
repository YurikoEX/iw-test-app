...
class CfClientWorker extends Worker implements ICfClientWorker{
    ...
    constructor(comm: IComm, service: IAm, opts?: ICfClientWorkerOpts) {
        super([], comm, service, {
            id: idHelper.newId(),
            name: 'iw-cf-clients'
        });
    ...
    private constructServiceUrl(service:ICfClient){
    ...
    public start(dependencies: ICollection<IDependency<IWorkerChild>>, callback?: (e: Error) => void) {
        ...
        _.each(instance.userProvidedServices,(ups)=>{
            instance.comm.listen(instance.comm.prefix() + '.' + ups.serviceName + '.*.*.*', (...args: any[]) => {
                ...
                var serviceUrl = instance.constructServiceUrl(service);
